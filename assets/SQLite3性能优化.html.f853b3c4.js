import{_ as e}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as i,c as n,f as s}from"./app.bf3f43c3.js";const d={},t=s(`<h1 id="sqlite3性能优化" tabindex="-1"><a class="header-anchor" href="#sqlite3性能优化" aria-hidden="true">#</a> SQLite3性能优化</h1><h2 id="场景描述" tabindex="-1"><a class="header-anchor" href="#场景描述" aria-hidden="true">#</a> 场景描述</h2><p>有10000条数据需要插入数据库，原来未优化的代码为直接循环执行INSERT语句。</p><div class="language-C++ line-numbers-mode" data-ext="C++"><pre class="language-C++"><code>void test0()
{
    sqlite3 *db = NULL;
