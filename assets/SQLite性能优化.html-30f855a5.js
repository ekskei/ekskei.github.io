import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,d as s}from"./app-18ea6252.js";const d={},t=s(`<h1 id="sqlite性能优化" tabindex="-1"><a class="header-anchor" href="#sqlite性能优化" aria-hidden="true">#</a> SQLite性能优化</h1><h2 id="场景描述" tabindex="-1"><a class="header-anchor" href="#场景描述" aria-hidden="true">#</a> 场景描述</h2><p>有10000条数据需要插入数据库，原来未优化的代码为直接循环执行INSERT语句。</p><div class="language-C++ line-numbers-mode" data-ext="C++"><pre class="language-C++"><code>void test0()
{
    sqlite3 *db = NULL;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="测试结果" tabindex="-1"><a class="header-anchor" href="#测试结果" aria-hidden="true">#</a> 测试结果</h2><p>我在自己电脑上测试了以上各种情况，打印程序执行所用的时间(ms)，数据如下表：</p><table><thead><tr><th>synchronous</th><th>FULL(默认)</th><th>NORMAL</th></tr></thead><tbody><tr><td>不优化</td><td>1447405</td><td>977747</td></tr><tr><td>使用事务</td><td>1580</td><td>1168</td></tr><tr><td>使用事务+执行准备</td><td>1436</td><td>1004</td></tr><tr><td>使用事务+执行准备+内存模式</td><td>15</td><td>9</td></tr></tbody></table>`,19),l=[t];function a(r,c){return i(),n("div",null,l)}const o=e(d,[["render",a],["__file","SQLite性能优化.html.vue"]]);export{o as default};
