import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{o as e,c as a,d as n}from"./app-94a291f6.js";const d={},l=n(`<h1 id="动态库开发" tabindex="-1"><a class="header-anchor" href="#动态库开发" aria-hidden="true">#</a> 动态库开发</h1><p>动态库是一种可以在程序运行时被动态加载的共享库，它包含了一组函数和数据，可以被多个程序共享使用，在C/C++代码重用和模块化开发中有着广泛的应用。动态库通常采用共享对象文件（.so）或者动态链接库文件（.dll）的格式存储在磁盘上。本文将介绍动态库的开发方法以及注意事项，帮助了解如何编写高质量的动态库。</p><h2 id="导出函数" tabindex="-1"><a class="header-anchor" href="#导出函数" aria-hidden="true">#</a> 导出函数</h2><p>编写要导出的函数时，需要使用特殊的关键字和修饰符来标识它们是动态库的导出函数。</p><p>例如，在Linux系统下，可以使用__attribute__((visibility(&quot;default&quot;)))修饰符来标识：</p><div class="language-C line-numbers-mode" data-ext="C"><pre class="language-C"><code>__attribute__((visibility(&quot;default&quot;))) int add(int a, int b)
{
    return a + b;
}
